...
def request(url, post=None, headers=None, mobile=False, safe=False, timeout='60'):
    try:
        ...
        cookie = cache.get(cloudflare, 3, u, post, headers, mobile, safe, timeout, table='cookies')
        ...
        if 'HTTP Error 503' in result[0]:
            cookie = cache.get(cloudflare, 0, u, post, headers, mobile, safe, timeout, table='cookies')
