	...
	try:
		...
		for i in links:
			try:
				...
				try: sources.append({'quality': 'HD', 'url': [i['url'] for i in result if i['width'] == 1280 and 'google' in i['url']][0]})
				except: pass
				...
				try: sources.append({'quality': 'HD', 'url': [i['url'] for i in result if i['width'] == 1280 and not 'google' in i['url'] and not 'mediafire' in i['url']][0]})
				except: pass
			except:
				pass
	except:
