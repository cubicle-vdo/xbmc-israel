...
__REFERER__ = 'http://www.sdarot.pw/templates/frontend/blue_html5/player/jwplayer.flash.swf'
...
def getData_attempt(url, timeout=__cachePeriod__, name='', postData=None,referer=__REFERER__):
        ...
        req.add_header('Host','www.sdarot.pw')
        req.add_header('Origin','http://www.sdarot.pw')
        if (postData):
